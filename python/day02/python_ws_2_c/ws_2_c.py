...
first_data = {'제목' : data[0]['results'][0]['properties']['제목']['title'][0]['plain_text'], '일차' : int(data[0]['results'][0]['properties']['일차']['number']), '단계' : f"{data[0]['results'][0]['properties']['단계']['select']['name']}단계", '과목' : data[0]['results'][0]['properties']['과목']['multi_select'][0]['name']}
print(first_data)
